  ...
  return (
    <ContentLayout>
      <View style={styles.textContainer}>
        ...
        <Body>
          We hebben er samen voorgezorgd dat jij je basis op orde hebt. Nu hoef
          je je daar geen zorgen meer om te maken en kan je weer terug naar
          leuke dingen doen.
        </Body>
      </View>
      <View style={styles.textContainer}>
        ...
        <Body>
          ...
          routes je graag in de Ping Ping app zou willen zien. Wanneer de route
          is afgestemd kan hij uiteindelijk in de app verschijnen.
        </Body>
      </View>
