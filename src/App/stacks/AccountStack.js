...
function AccountStack() {
	return (
		<Stack.Navigator
			initialRouteName={routes.accountStack.screens.homeScreen}
			screenOptions={{ headerShown: false }}
		>
			<Stack.Screen
				name={routes.accountStack.screens.homeScreen}
				component={AccountHomeScreen}
			/>
			<Stack.Screen
				name={routes.accountStack.screens.privacyPolicyScreen}
				component={PrivacyPolicyScreen}
			/>
			<Stack.Screen
				name={routes.accountStack.screens.deleteDataScreen}
