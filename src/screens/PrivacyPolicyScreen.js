...
import { ASYNC_STORAGE_KEYS, ONBOARDING_STATES } from '../config/constants';
	...
	const doAcceptPolicy = async () => {
		...
		try {
			...
			await multiSetAsyncStorage([
				[ASYNC_STORAGE_KEYS.acceptedPolicy, JSON.stringify(true)],
				[ASYNC_STORAGE_KEYS.onboardingStatus, ONBOARDING_STATES.onboardingQuestionsStarted],
			]);
